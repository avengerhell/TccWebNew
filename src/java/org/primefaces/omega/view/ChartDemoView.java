...
import com.burgosanchez.tcc.venta.jpa.EntradaFacade;
...
public class ChartDemoView implements Serializable {
    ...
    @Inject
    private EntradaFacade entradaEJB;
    ...
    private BarChartModel initBarModel() {
        ...
        ChartSeries boys = new ChartSeries();
        List<TotalEventoChart> totales = entradaEJB.obtenerTotalEntradasSexo("H");
        boys.setLabel("Hombres");
        if (totales != null) {
            for (TotalEventoChart l : totales) {
                boys.set(l.getNombre(), l.getTotal());
            }
        } 
        ChartSeries girls = new ChartSeries();
        girls.setLabel("Mujeres");
        List<TotalEventoChart> totalesMujeres = entradaEJB.obtenerTotalEntradasSexo("M");
        if (totalesMujeres != null) {
            for (TotalEventoChart l : totalesMujeres) {
                girls.set(l.getNombre(), l.getTotal());
            }
        } 
        model.addSeries(boys);
        model.addSeries(girls);
    ...
    private void createBarModel() {
        ...
        barModel.setTitle("Genero/Evento");
    ...
    private void createPieModel1() {
        ...
        List<TotalEventoChart> totales = entradaEJB.obtenerTotalEntradas();
        if (totales != null) {
            for (TotalEventoChart l : totales) {
                pieModel1.set(l.getNombre(), l.getTotal());
            }
            pieModel1.setTitle("Totales por evento");
            ...
            pieModel1.setTitle("Ejemplo Pie");
            pieModel1.setLegendPosition("w");
            pieModel1.setExtender("skinPie");
        }
    }
